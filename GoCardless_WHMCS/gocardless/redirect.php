    ...
    if($invoiceID) {
        ...
        switch ($_GET['resource_type']) {
            ...
            case 'bill':
                ...
                insert_query('mod_gocardless', array('invoiceid' => $invoiceID, 'billcreated' => 1, 'resource_id' => $_GET['resource_id'], 'preauth_id' => NULL));
                break;
        ...
        if($gateway['instantpaid'] == 'on') {
            ...
            logTransaction($gateway['name'], 'GoCardless Invoice Instant Paid: ' . print_r($bill, true), 'Successful');
        }
